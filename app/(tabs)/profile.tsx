                            ...
                            <View key={item.id} style={styles.myForecastRow}>
                                ...
                                >
                                    <View
                                        style={[
                                            styles.profitBadge,
                                            { backgroundColor: item.profit >= 0 ? '#ecfdf5' : '#fef2f2' },
                                        ]}
                                    >
                                        <Text
                                            style={[
                                    ...
                                    <View style={styles.myForecastInfo}>
                                        ...
                                        <Text style={styles.myForecastContent2} numberOfLines={1}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => handleDeleteForecast(item.id)}
                                >
...
const styles = StyleSheet.create({
    ...
    myForecastContent2: { fontSize: 12, color: '#aaa', fontWeight: '500' },
